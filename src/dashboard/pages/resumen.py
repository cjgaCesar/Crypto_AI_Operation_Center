...
from src.dashboard.layout import get_cards_per_row, is_compact, render_responsive_grid, render_view_mode_selector
...
def render(service: DashboardService, exchange: str) -> None:
    ...
    # layout.render_view_mode_selector() (compartido con 'Mercado'), no por
    # esta página. El modo elegido se conserva al navegar entre páginas;
    # solo vive en st.session_state, nunca se escribe a disco ni a
    # config.yaml.
